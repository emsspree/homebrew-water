...
**A [Tap](https://docs.brew.sh/Taps) for the macOS package manager [Homebrew](https://brew.sh).**
...
For [OpenThesaurus.de](https://www.openthesaurus.de/) use [Tekl’s Tap](https://github.com/Tekl/homebrew-dictionaries) instead.
